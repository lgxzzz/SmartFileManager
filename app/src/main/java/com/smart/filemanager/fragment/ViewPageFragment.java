...
import com.smart.filemanager.view.PagerSlidingTabStrip;
...
public class ViewPageFragment extends Fragment {
    ...
    private ArrangeFragment mArrangeFragment = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mPagerItemList.add(mArrangeFragment);

        mAdapter = new ViewPagerAdapter(getFragmentManager(), new String[] { "目录", "分类", "整理" });
